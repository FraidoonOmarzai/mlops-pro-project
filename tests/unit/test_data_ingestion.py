...
from src.components.data_ingestion import DataIngestion, DataIngestionConfig, create_data_ingestion_config
...
def test_config_default_values():
    ...
    config = DataIngestionConfig(raw_data_path="data.csv", train_data_path="train.csv", test_data_path="test.csv")
